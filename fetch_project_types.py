...
for project in projects:
    ...
    projects_types_dict[project_type_link] = {
    ...
    for project_type_local in project_types_local:
        ...
        project_type_local_link = str(project_type_local["href"])
        projects_types_dict[project_type_link]["local_types"][project_type_local_link] = project_type_local_name
